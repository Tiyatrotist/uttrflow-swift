...
.PHONY: feed-url-test
feed-url-test: ## Exercise every feed URL the bundle and publish gates accept or refuse. Needs no build.
	./Scripts/feed_url_classify_test.sh
