...
SCENARIOS=(
  "term-git-c-accept|term|t:25:git c; eg:3; shot:ghost; k:124; p:700; ex:ACCEPT chars=[0-9]+ typedChars=5 via=:2; rb:line: git [a-z-]{2,}( .*)?$"
  "term-ls-has-corpus|term|t:25:ls; ex:QUERY typedChars=2 corpus=[1-9]:3; ex:VERIFY typedChars=2 in=[1-9]:3"
  "term-fast-burst-then-pause|term|t:12:git ch; eg:3"
  "term-slow-typing|term|t:220:git st; eg:3"
  "term-git-s-accept|term|t:25:git s; eg:3; k:124; p:700; ex:ACCEPT chars=[0-9]+ typedChars=5 via=:2; rb:line: git [a-z-]{2,}( .*)?$"
  "term-typed-past-3x-goes-quiet|term|t:25:git c; el:3; t:25:x; p:900; k:51; el:3; t:25:z; p:900; k:51; el:3; t:25:q; ex:QUIET typedChars=6 .*rejections=3:3"
  ...
  "term-finished-command-one-pass|term|t:25:ls -la; ex:(GENERATE|VERIFY|QUIET) .*typedChars=6 :4; p:5000; count:GENERATE .*typedChars=6 .*elapsed=[1-9][0-9]{2,}ms:1"
  "term-single-char-no-model-pass|term|t:25:g; ex:(QUERY|QUIET) typedChars=1 :2; nx:GENERATE .*typedChars=1 :2"
  "loop-tick-alive|term|p:2500; ex:TURN front=:3"
  "edit-prose-pause-rich|edit|t:15:Deploy the re; ex:QUIET typedChars=([7-9]|1[0-3]) .*writingFluently:2; ex:QUERY typedChars=13 corpus=:3; eg:3; shot:ghost-rich"
  ...
  "edit-long-line-230|edit|t:6:${LONG230}; ex:GENERATE .*typedChars=2[0-9]{2} got=:6"
  "edit-line-over-256-silent|edit|t:5:${LONG270}; ex:QUIET typedChars=(2[4-9][0-9]|[3-9][0-9]{2}) reason=lineTooLong:3; nx:(QUERY|GENERATE) .*typedChars=(2[4-9][0-9]|[3-9][0-9]{2}) :1"
  ...
  "safari-git-ghost|safari|t:25:git; el:5; ex:GENERATE .*typedChars=3 got=[1-9]:5"
  "safari-lin-ghost|safari|t:25:lin; el:5; ex:GENERATE .*typedChars=3 got=[1-9]:5"
  "safari-escape-dismisses|safari|t:25:git; eg:4; k:53; ex:SWALLOWED key=escape .*decision=redraw:2; nx:SWALLOWED key=return:1"
  "finder-search-short-query|finder|t:25:readme; ex:(GENERATE .*got=[1-9]|VERIFY .*out=[1-9]|QUIET typedChars=6 reason=[a-zA-Z]|TURN front=com.apple.finder .*placement=nil):4"
  "cross-terminal-textedit-terminal|cross|t:25:git c; eg:3; front:edit; gone:1.5; t:15:Deploy the re; first:(GENERATE|VERIFY|QUERY) .*typedChars=:typedChars=13 :3; front:term; first:(GENERATE|VERIFY|QUERY) .*typedChars=:typedChars=5 :3"
)
